"""Sentiment analysis module using Watson NLP BERT model."""
import requests
import json


def sentiment_analyzer(text_to_analyse):
    """Sends the given text to the Watson NLP sentiment analysis API
    and returns the sentiment label and confidence score.
    """
